  ...
  render() {
    return (
      ...
      >
        ...
        <Text style={styles.B}>You need not Search fot them agin</Text>
        <View style={{ flex: 1, flexDirection: 'row' }}>
          <Image
            ...
            source={{
              uri:
                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR9T2M2CIGCBRfqgb2BiabzYv-SJw4aowi-wfptwNMSb35Eair'
            }}
          ></Image>
        ...
        >
          <View style={{ flex: 3, marginLeft: 15, marginTop: 15 }}>
            <Text style={styles.Hdng}>Best of jai</Text>
          </View>
          <TouchableOpacity
          ...
          >
            <Text style={styles.Hdng}>Best Of </Text>
          </View>
          <View
